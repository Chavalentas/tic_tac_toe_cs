...
{
    public class ConsoleDrawGameObjectVisitor : DrawGameObjectVisitor
    {
        private int _currentX;

        private int _currentY;

        public ConsoleDrawGameObjectVisitor(int initialX, int initialY, char initialCircleChar, char initialCrossChar,
            ConsoleColor initialBackgroundColor, ConsoleColor initialForegroundColor)
        {
            CurrentX = initialX;
            CurrentY = initialY;
            CircleChar = initialCircleChar;
            CrossChar = initialCrossChar;
        ...
        public char CircleChar
        {
            get;
            set;
        }

        public char CrossChar
        {
            get;
            set;
        }
        ...
        public override void Visit(Circle circle)
        {
            ...
            ConsolePrinter.Print(CurrentX, CurrentY, Convert.ToString(CircleChar), CurrentBackgroundColor, CurrentForegroundColor);
        }
        ...
        public override void Visit(Cross cross)
        {
            ...
            ConsolePrinter.Print(CurrentX, CurrentY, Convert.ToString(CrossChar), CurrentBackgroundColor, CurrentForegroundColor);
        }
    }
}
